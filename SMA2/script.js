...
// Post data
const posts = [
  // shoppable factor static
  {
    type: "image",
    username: "factormeals",
    media: [
      "https://github.com/Alice-Ji/SMShoppable/blob/main/ad-factor-SM-static2.jpg?raw=true",
    ],
  ...
  // nonshoppable ultima video
  {
    type: "video",
    username: "ultima",
    media: [
      "https://github.com/Alice-Ji/SMShoppable/blob/main/ad-ultima-SM-video1.mp4?raw=true",
    ],
    caption: "Sponsored Content",
    likes: 0,
    liked: false,
